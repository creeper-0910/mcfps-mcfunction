...
execute as @a if entity @s[nbt={SelectedItem:{tag:{Type:"AR"}}}] unless score @s Speed matches 9 run attribute @s generic.movement_speed base set 0.09
execute as @a if entity @s[nbt={SelectedItem:{tag:{Type:"SR"}}}] unless score @s Speed matches 7 run attribute @s generic.movement_speed base set 0.07
execute as @a if entity @s[nbt={SelectedItem:{tag:{Type:"LMG"}}}] unless score @s Speed matches 8 run attribute @s generic.movement_speed base set 0.08
