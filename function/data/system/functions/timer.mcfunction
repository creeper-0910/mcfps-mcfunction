...
execute if score #dummy success matches 0 if score #dummy last_time matches 0 run tellraw @a {"text":"リング収縮中だよ～"}
execute if score #dummy success matches 1 if score #dummy last_time matches 0 run tellraw @a {"text":"リング収縮中だよ～"}
