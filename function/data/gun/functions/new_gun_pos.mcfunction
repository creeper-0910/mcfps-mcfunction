...
#execute at @s run tp @e[tag=bullet_] ~ ~1.62 ~ ~ ~
...
#execute at @s as @e[tag=bullet_] facing entity @e[tag=SpreadMarker,sort=nearest,limit=1] feet anchored eyes run function gun:bullet_move_new
#kill @e[tag=bullet_]
