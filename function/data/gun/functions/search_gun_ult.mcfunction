execute as @a if entity @s[scores={Charge_Search=10..},nbt={Inventory:[{Slot:-106b,Count:1b,tag:{CustomModelData:4}}]}] at @s run scoreboard players reset @s Charge_Search
