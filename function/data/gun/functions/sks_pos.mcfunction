...
# 90 = 120 * 0.75
execute as @e[tag=Enemy,distance=..90] run function gun:gun_hit
execute as @e[tag=HitterT] run damage @s 7 system:shot by @p[tag=Shooter]
...
item modify entity @s weapon.mainhand gun:gun_bullet_name/sks
