...
execute at @s run summon item_display ^ ^ ^1 {Tags:["ryujin","init_ryujin_no_ken_wo_kurae"],item:{id:"minecraft:sea_lantern",Count:1,tag:{CustomModelData:12}},transformation:[0.0000f,0.0000f,0.0625f,0.0000f,0.0625f,-0.0000f,0.0000f,-0.1000f,0.0000f,0.0625f,-0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]}
