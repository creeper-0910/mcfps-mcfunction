...
execute if entity @s[team=Red] run tag @e[type=#bullet_hit,type=!player] add Enemy
execute if entity @s[team=Blue] run tag @a[team=Red] add Enemy
execute if entity @s[team=Blue] run tag @e[type=#bullet_hit,type=!player] add Enemy
