...
execute as @a at @e[tag=pylon,sort=nearest,limit=1] run scoreboard players reset @a[distance=5..] Pylon_heal
...
execute as @e[tag=test_poll] at @s facing entity @e[tag=test_poll,distance=0.3..10] eyes positioned ^ ^-1 ^ run function skill:poll_loop2
