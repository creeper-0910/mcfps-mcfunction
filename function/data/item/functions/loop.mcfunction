...
execute at @e[tag=FlashBang] run particle minecraft:flash ~ ~ ~ 7 7 7 10 200 force
execute as @e[scores={flashbang_timer=50..},tag=FlashBang] run kill @s
particle minecraft:flash ~ ~ ~ 7 7 7 10 200 force
